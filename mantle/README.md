...
**Three broker implementations and every transport.** Mosquitto 2, EMQX 5 and HiveMQ CE — the last being the
broker the Sparkplug TCK itself is built on — over `tcp://`, `ssl://`, mutual TLS, `ws://` and `wss://`.
